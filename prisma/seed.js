...
async function main() {
  console.log("Seeding verified Premier League clubs...");
  ...
  console.log("Seeding 10 Real Gameweek 1 Fixtures...");
  ...
  console.log("Database seeded successfully with accurate data!");
}
